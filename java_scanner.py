...
Examples:
  ...
  python3 java_scanner.py /path/to/src --severity HIGH
  python3 java_scanner.py build.gradle --verbose
""",
    )
    parser.add_argument("target", help="File or directory to scan (.java, pom.xml, build.gradle, web.xml, .properties, .yml, .yaml, .jar, .war, .ear)")
