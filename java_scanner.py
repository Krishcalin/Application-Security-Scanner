...
Scans Java, PHP, and Python (including AI/agentic) applications for security
...
class JavaScanner:
    ...
    def save_json(self, output_path):
        report = {
            "scanner": f"Java, PHP & Python Security Scanner v{VERSION}",
...
def main():
    parser = argparse.ArgumentParser(
        description=f"Java, PHP & Python Security Scanner v{VERSION}",
...
""",
    ...
    parser.add_argument("target", help="File or directory to scan (.java, .php, .py, pom.xml, requirements.txt, Pipfile, pyproject.toml, .gradle, .war, .jar, .ear, php.ini)")
    ...
    print(f"[*] Java, PHP & Python Security Scanner v{VERSION}")
